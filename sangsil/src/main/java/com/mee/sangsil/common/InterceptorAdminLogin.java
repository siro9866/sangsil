...
@Controller
public class InterceptorAdminLogin extends HandlerInterceptorAdapter{
	private static final Logger logger = LoggerFactory.getLogger(InterceptorAdminLogin.class);
	
	@Value("#{config['CD_ID_AAA01']}") String user_auth_AllAdmin;
	...
	public boolean preHandle(HttpServletRequest request,HttpServletResponse response, Object handler) throws Exception {
		...
		if(session.getAttribute("USER_NM") == null){
			response.sendRedirect("/common/login/infoForm.mee");
			return false;
		}
