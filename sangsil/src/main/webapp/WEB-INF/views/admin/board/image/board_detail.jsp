										...
										<td>
											<c:choose>
												...
												<c:otherwise>
													...
													<c:forEach items="${fileList }" var="resultFile">
														<div class="my-thumb-1">
															<script>
																if(browserCheck == "MOBILE"){
																	document.write("<img src=\"${resultFile.view_path_name}${resultFile.file_name}\">");
																}else{
																	document.write("<a href=\"/fileDownload.mee?path=${resultFile.path_name}&fileName=${resultFile.file_name}&originalFileName=${resultFile.originalFileName}\"><img src=\"${resultFile.view_path_name}${resultFile.file_name}\"></a>");
																}
															</script>
<%-- 															<a href="/fileDownload.mee?path=${resultFile.path_name}&fileName=${resultFile.file_name}&originalFileName=${resultFile.originalFileName}"><img src="${resultFile.view_path_name}${resultFile.file_name}"></a> --%>
<%-- 															<img src="${resultFile.view_path_name}${resultFile.file_name}" onclick="showbPopup('${resultFile.view_path_name}${resultFile.file_name}')"> --%>
														</div>
													</c:forEach>
