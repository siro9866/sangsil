...
<body>
	<div>
		<p>
			...
			<button class="btnSearch">조회</button>
		</p>
	</div>
	<div>
		<table id="exampleTable" class="display" style="width: 80%">
			<thead>
				<tr>
					<th>Name</th>
					<th>Position</th>
...
$(function(){
	...
	// Getter
	var iconPosition = $( ".btnSearch" ).button( "option", "iconPosition" );
	// Setter
	$( ".btnSearch" ).button( "option", "iconPosition", "end" );
