...
.pop_container .drag_area .bg{display:block;position:absolute;top:0;left:0;width:341px;height:129px;background:#fdfdfd url(/resources/plugIn/SmartEditor/SE2.3.10.O11329/img/photoQuickPopup/bg_drag_image.png) 0 0 no-repeat}
...
$(document).ready(function($){
	...
	window.fn_multiUpload = function(sUploadURL, tempFile){
		var formData = new FormData();
		formData.append('Filedata', tempFile);
		formData.append('urlGbn', 'cms');
		...
		$.ajax({
			...
			success:function(data){
				if(data.retCode == "9998"){
					alert("업로드 용량(총 10MByte) 응 초과하였습니다.");
					return false;
				}else{
					var filePath = data.path + data.filename;
					//전달해야할 응답내용
					var sResString = "sFileURL=" + filePath + "&sFileName="+data.filename + "&bNewLine=true";
...
<div id="pop_wrap">
	...
	<div id="pop_container2" class="pop_container2">
    	<!-- content -->
		<form id="editor_upimage" name="editor_upimage" action="/smartFileUpload.mee" method="post" enctype="multipart/form-data" onSubmit="return false;">
        <div id="pop_content2">
    ...
    <div id="pop_footer">
	    <div class="btn_area">
            <a href="#"><img src="/resources/plugIn/SmartEditor/SE2.3.10.O11329/img/photoQuickPopup/btn_confirm.png" width="49" height="28" alt="확인" id="btn_confirm"></a>
            <a href="#"><img src="/resources/plugIn/SmartEditor/SE2.3.10.O11329/img/photoQuickPopup/btn_cancel.png" width="48" height="28" alt="취소" id="btn_cancel"></a>
        </div>
    </div>
    <!-- //footer -->
</div>

<script type="text/javascript" src="/resources/plugIn/SmartEditor/SE2.3.10.O11329/photo_uploader/popup/jindo.min.js" charset="utf-8"></script>
<script type="text/javascript" src="/resources/plugIn/SmartEditor/SE2.3.10.O11329/photo_uploader/popup/jindo.fileuploader.js" charset="utf-8"></script>
<script type="text/javascript" src="/resources/plugIn/SmartEditor/SE2.3.10.O11329/photo_uploader/popup/attach_photo.js" charset="utf-8"></script>
