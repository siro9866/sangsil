	 ...
	 */
     function goStartMode(){
    	 ...
    	 if(sSrc.indexOf("btn_confirm2.png") < 0 ){
    		 welBtnConfirm.attr("src","/resources/plugIn/SmartEditor/SE2.3.10.O11329/img/photoQuickPopup/btn_confirm2.png");
     ...
     function goReadyMode(){
    	 ...
    	 if(sSrc.indexOf("btn_confirm2.png") >= 0 ){
	    	 ...
	    	 welBtnConfirm.attr("src","/resources/plugIn/SmartEditor/SE2.3.10.O11329/img/photoQuickPopup/btn_confirm.png");
    	 }
     }   
    ...
    function addImage(ofile){
		...
		if( !!bExceedLimitTotalSize ){
	        ...
	        aFileList.push('	<a onclick="delImage(\'img'+nImageInfoCnt+'\')"><img class="del_button" src="/resources/plugIn/SmartEditor/SE2.3.10.O11329/img/photoQuickPopup/btn_del.png"  width="14" height="13" alt="첨부 사진 삭제"></a>');
			aFileList.push('	</li> ');   
    ...
    function html5Upload() {	
    	...
    	sUploadURL= "/smartFileUpload.mee"; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			...
 			//SmartEditor 이미지업로드부분 수정
 			sUrl  : '/smartFileUpload.mee',	//샘플 URL입니다.
...
// 	        sCallback : location.href.replace(/\/[^\/]*$/, '') + '/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
 			...
 			sFiletype : "*.jpg;*.png;*.bmp;*.gif;*.jpeg;*.JPG;*.JPEG;*.PNG;*.BMP;*.GIF",						//허용할 파일의 형식. ex) "*", "*.*", "*.jpg", 구분자(;)	
